...
std::vector<gl_engine_exe::opengl_attr_pair> st_config =
{
    {SDL_GL_RED_SIZE,					8},
    {SDL_GL_GREEN_SIZE,					8},
    {SDL_GL_BLUE_SIZE,					8},
...
void spinning_shader_ball_scene(gl_engine_exe::Window window);
void three_shader_ball_scene(gl_engine_exe::Window window);
void g_buffer_scene(gl_engine_exe::Window window);
...
int main(int, char**)
{
	...
	gl_engine_exe::Window window{ "GL Engine", st_config, width, height };
...
{
	// Target Camera
	gl_engine_exe::TargetCamera targetCam{};
	gl_engine_exe::CameraNode targetCam_node{ "Target Camera 1", &targetCam };
	targetCam.set_position({ 0.0f, 8.0f, 8.0f });
	targetCam.set_clip_far(1000.0f);

	// Orthogonal Camera
	gl_engine_exe::OrthoCamera orthoCam{};
	gl_engine_exe::CameraNode orthoCam_node{ "Ortho Cam 1", &orthoCam };
	orthoCam.set_clip_near(0.001f);
	orthoCam.set_clip_far(100.0f);
	orthoCam.set_sides(-30.0f, 30.0f, -30.0f, 30.0f);

	// Free Camera
	gl_engine_exe::FreeCamera freeCam{};
	gl_engine_exe::CameraNode freeCam_node{ "Free Cam 1", &freeCam };
	freeCam.set_clip_near(0.001f);
	freeCam.set_clip_far(1000.0f);

	// Colors
	gl_engine_exe::Texture white_tex{		glm::vec3{1.00f, 1.00f, 1.00f} };
	gl_engine_exe::Texture light_grey_tex{	glm::vec3{0.85f, 0.85f, 0.85f} };
	gl_engine_exe::Texture grey_tex{		glm::vec3{0.50f, 0.50f, 0.50f} };
	gl_engine_exe::Texture dark_grey_tex{	glm::vec3{0.25f, 0.25f, 0.25f} };
	gl_engine_exe::Texture blue_tex{		glm::vec3{0.25f, 0.25f, 1.00f} };
	gl_engine_exe::Texture normal_up{		glm::vec3{0.50f, 0.50f, 1.00f} };

	// Textures
	gl_engine_exe::Texture uv_template_b_tex{ "uvtemplateB.tga"  };
	gl_engine_exe::Texture grey_grid_tex{ "greyGrid_01.tga" };
	gl_engine_exe::Texture brick_normals{ "bricks2_normal.tga" };
	gl_engine_exe::Texture brick_displacement{ "bricks2_disp.tga" };



	// Shader 1
	gl_engine_exe::BlinnMaterial shaderBall_material{ "Shaderball Blinn" };
	...
	// Shader 2
	gl_engine_exe::BlinnMaterial floor_material{ "Floor Blinn" };
	...
	// Mesh 1
	gl_engine_exe::Mesh shaderBall = gl_engine_exe::OBJ_Loader::load_obj("shaderball_lowpoly_02_tris.obj");
	gl_engine_exe::MeshNode shaderBall_node{ "shader ball", &shaderBall, &shaderBall_material };

	// Mesh 2
	gl_engine_exe::Mesh plane = gl_engine_exe::Plane::create_plane(100.0f, 100.0f, 1, 1);
	plane.scale_uvs(10.0f);
	gl_engine_exe::MeshNode plane_node{ "Plane 1", &plane, &floor_material };
	...
	// Point Light 1
	gl_engine_exe::PointLight pointLight{ 1.0f, { 0.0f, 0.0f, 0.0f } };
	pointLight.set_brightness(4.1f);
	pointLight.set_color(glm::vec3(1.0, 0.7, 0.2));
	pointLight.set_radius(0.1f);
	//pointLight.disable_mesh();
	gl_engine_exe::LightNode pointLight_node{ "Point Light 1", &pointLight };
	pointLight_node.set_position({ -4.0f, 1.2f, 0.0f });

	// Point Light 2
	gl_engine_exe::PointLight pointLight2{ 9.0f, { 0.2f, 0.1f, 1.0f } };
	gl_engine_exe::LightNode pointLight_node2{ "Point Light 2", &pointLight2 };
	pointLight_node2.set_position({ 0.0f, 4.0f, -5.0f });

	// Directional Light 1
	gl_engine_exe::DirectionalLight directionalLight1{ 0.1f, {1.0f, 1.0f, 1.0f} /*{ 0.2f, 1.0f, 0.1f }*/ };
	gl_engine_exe::LightNode directionalLight_node1{ "Directional Light 1", &directionalLight1 };
	...
	// Spot Light 1
	gl_engine_exe::SpotLight spotLight1{ 10.0f, { 1.0f, 0.0f, 0.0f } };
	gl_engine_exe::LightNode spotLight_node1{ "Spot Light 1", &spotLight1 };
	...
	// Spot Light 2
	gl_engine_exe::SpotLight spotLight2{ 14.0f, {0.0f, 0.0f, 1.0f } };
	gl_engine_exe::LightNode spotLight_node2{ "Spot Light 2", &spotLight2 };
	...
	// Shadow map
	gl_engine_exe::ShadowMap shadowMap_directional1{ &directionalLight_node1 };
	gl_engine_exe::ShadowMap shadowMap_spot1{ &spotLight_node1 };
	gl_engine_exe::ShadowMap shadowMap_spot2{ &spotLight_node2 };
	gl_engine_exe::ShadowMap shadowMap_point1{ &pointLight_node };
	gl_engine_exe::ShadowMap shadowMap_point2{ &pointLight_node2 };

	//shadowMap_point2.set_clip_far(25.0f);

	// Null node 1
	gl_engine_exe::Node lightRotate1{ "light rotate 01" };
	//lightRotate1.add_child(&pointLight_node);

	// Null node 2
	gl_engine_exe::Node lightRotate2{ "light rotate 02" };
	lightRotate2.add_child(&lightRotate1);
	lightRotate2.set_position({ 3.0, 0.0, 0.0 });

	// Axis arrows
	gl_engine_exe::Mesh axis_arrow{ gl_engine_exe::Arrow::create_arrow(20) };
	gl_engine_exe::Material axis_mat_x{ "axis arrow x", "Light.vert", "Light.frag" };
	gl_engine_exe::Material axis_mat_y{ "axis arrow x", "Light.vert", "Light.frag" };
	gl_engine_exe::Material axis_mat_z{ "axis arrow x", "Light.vert", "Light.frag" };
	...
	gl_engine_exe::MeshNode axis_arrow_x_node{ "axis arrow x node", &axis_arrow, &axis_mat_x };
	gl_engine_exe::MeshNode axis_arrow_y_node{ "axis arrow y node", &axis_arrow, &axis_mat_y };
	gl_engine_exe::MeshNode axis_arrow_z_node{ "axis arrow z node", &axis_arrow, &axis_mat_z };
	...
	// Renderer
	gl_engine_exe::Renderer render{ &targetCam_node, glm::uvec2(window.width(), window.height()) };
...
void three_shader_ball_scene(gl_engine_exe::Window window)
{
	...
	// Colors
	gl_engine_exe::Texture white_tex{		glm::vec3{1.00f, 1.00f, 1.00f} };
	gl_engine_exe::Texture lighter_grey_tex{glm::vec3{0.95f, 0.95f, 0.95f} };
	gl_engine_exe::Texture light_grey_tex{	glm::vec3{0.85f, 0.85f, 0.85f} };
	gl_engine_exe::Texture grey_tex{		glm::vec3{0.50f, 0.50f, 0.50f} };
	gl_engine_exe::Texture dark_grey_tex{	glm::vec3{0.25f, 0.25f, 0.25f} };
	gl_engine_exe::Texture darker_grey_tex{	glm::vec3{0.10f, 0.10f, 0.10f} };
	gl_engine_exe::Texture red_tex{			glm::vec3{1.00f, 0.00f, 0.00f} };
	gl_engine_exe::Texture green_tex{		glm::vec3{0.00f, 1.00f, 0.00f} };
	gl_engine_exe::Texture blue_tex{		glm::vec3{0.00f, 0.00f, 1.00f} };
	gl_engine_exe::Texture normal_up{		glm::vec3{0.50f, 0.50f, 1.00f} };
	gl_engine_exe::Texture grid_tex{			"greyGrid_01.tga"		};
	gl_engine_exe::Texture brick_normals{		"bricks2_normal.tga"	};
	gl_engine_exe::Texture brick_displacement{	"bricks2_disp.tga"		};
	...
	// Shader Grey
	gl_engine_exe::BlinnMaterial grey_material_rough{			"grey material rough" };
	gl_engine_exe::BlinnMaterial grey_material_mid{				"grey material mid" };
	gl_engine_exe::BlinnMaterial grey_material_shiny{			"grey material shiny" };
	gl_engine_exe::BlinnMaterial grey_material_rough_mapped{	"grey material rough" };
	gl_engine_exe::BlinnMaterial grey_material_mid_mapped{		"grey material mid" };
	gl_engine_exe::BlinnMaterial grey_material_shiny_mapped{	"grey material shiny" };
	...
	gl_engine_exe::MeshNode shaderBall_rough_node{		"shaderBall rough",			&shaderBall, &grey_material_rough };
	gl_engine_exe::MeshNode shaderBall_mid_node{		"shaderBall mid",			&shaderBall, &grey_material_mid };
	gl_engine_exe::MeshNode shaderBall_shiny_node{		"shaderBall shiny",			&shaderBall, &grey_material_shiny };
	gl_engine_exe::MeshNode shaderBall_rough_mapped_node{"shaderBall blinn rough",	&shaderBall, &grey_material_rough_mapped };
	gl_engine_exe::MeshNode shaderBall_mid_mapped_node{  "shaderBall blinn mid",	&shaderBall, &grey_material_mid_mapped };
	gl_engine_exe::MeshNode shaderBall_shiny_mapped_node{"shaderBall blinn shiny",	&shaderBall, &grey_material_shiny_mapped };

	std::vector<gl_engine_exe::MeshNode*> shaderBalls;
	...
	// Directional light 1
	gl_engine_exe::DirectionalLight directionalLight1{ 0.2f, {1.0f, 1.0f, 1.0f} /*{ 0.2f, 1.0f, 0.1f }*/ };
	gl_engine_exe::LightNode directionalLight_node1{ "Directional Light 1", &directionalLight1 };
	directionalLight_node1.set_rotation({ 33.0f, 225.0f, 0.0f });
	directionalLight_node1.set_position({ 16.0f, 16.0f, 16.0f });
...
void g_buffer_scene(gl_engine_exe::Window window)
{
	...
	gl_engine_exe::GBufferMaterial g_buffer_material{};

	//gl_engine::Material test_material{ "Test material", "Blinn.vert", "Blinn.frag" };

	// Textures
	gl_engine_exe::Texture diffuse_texture{ "uvtemplate.tga" };
	gl_engine_exe::Texture spec_texture{ "greyGrid_01.tga" };

	g_buffer_material.set_texture(gl_engine_exe::GBufferMaterial::k_material_diffuse, &diffuse_texture);
	g_buffer_material.set_texture(gl_engine_exe::GBufferMaterial::k_material_specular, &spec_texture);

	// Mesh node
	gl_engine_exe::MeshNode g_buffer_node{ "G Buffer Mesh Node", &shaderBall, &g_buffer_material };

	// Directional light 1
	gl_engine_exe::DirectionalLight directionalLight1{ 0.8f, {1.0f, 0.4f, 1.0f}};
	gl_engine_exe::LightNode directionalLight_node1{ "Directional Light 1", &directionalLight1 };
	directionalLight_node1.set_rotation({ 33.0f, 225.0f, 0.0f });
	directionalLight_node1.set_position({ 16.0f, 16.0f, 16.0f });
