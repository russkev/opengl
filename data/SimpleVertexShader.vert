...
void main(){
	...
	vec4 v				= vec4(vertexPosition[2], vertexPosition[2], vertexPosition[2], 1);
	...
	vec3 positionForFragment = vec3(ModelToWorldMatrix * v)*0.1;
	//f_worldPosition		= vec3(ModelToWorldMatrix * v);
	f_worldPosition			= positionForFragment;
}