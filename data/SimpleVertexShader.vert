...
void main(){
	...
	gl_Position				= umat_test * mat_modelToProjection * model_vertexPosition;
	...
	f_world_vertexPosition	= vec3(mat_modelToWorld * model_vertexPosition) * ufloat_test;
}