...
void GLShapes::createMatrixBuffer(const void* data, std::size_t size, std::uint32_t attribute, std::uint32_t vertexBufferID) {
...
void GLShapes::drawGeo(const Camera& cam, const glm::mat4& projection, std::uint32_t mode) {
